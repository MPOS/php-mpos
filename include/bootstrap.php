...
if (!include_once(INCLUDE_DIR.'/config/global.inc.dist.php')) {
    die('Unable to load base global config from ['.INCLUDE_DIR.'/config/global.inc.dist.php'.'] - '.$quickstartlink);
}
if (!@include_once(INCLUDE_DIR.'/config/global.inc.php')) {
    die('Unable to load your global config from ['.INCLUDE_DIR.'/config/global.inc.php'.'] - '.$quickstartlink);
}
...
if (!include_once(INCLUDE_DIR.'/config/security.inc.dist.php')) {
    die('Unable to load base security config from ['.INCLUDE_DIR.'/config/security.inc.dist.php'.'] - '.$quickstartlink);
}
if (@file_exists(INCLUDE_DIR.'/config/security.inc.php')) {
    include_once INCLUDE_DIR.'/config/security.inc.php';
}
