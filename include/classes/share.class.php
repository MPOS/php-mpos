...
class Share extends Base
{
   ...
   **/
  public function getMaxArchiveShareId()
  {
   ...
   **/
  public function getArchiveShares($iCount)
  {
  ...
  {
      // Fallbacks if unset
    if (!isset($this->config['archive']['purge'])) {
        $this->config['archive']['purge'] = 5;
    }
  ...
  {
      // Fallbacks if unset
    if (!isset($this->config['purge']['shares'])) {
        $this->config['purge']['shares'] = 25000;
    }
      if (!isset($this->config['purge']['sleep'])) {
          $this->config['purge']['sleep'] = 1;
      }
   ...
   **/
  public function getMinimumShareId($iCount, $current_upstream)
  {
      $stmt = $this->mysqli->prepare('
   ...
   **/
  public function getMinArchiveShareId($iCount)
  {
      $stmt = $this->mysqli->prepare('
