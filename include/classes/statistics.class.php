...
class Statistics extends Base
{
   ...
   **/
  public function getLastBlocksbyTime()
  {
      $this->debug->append('STA '.__METHOD__, 4);
      if ($data = $this->memcache->get(__FUNCTION__)) {
          return $data;
  ...
  {
      $this->debug->append('STA '.__METHOD__, 4);
      if ($data = $this->memcache->get(__FUNCTION__.$limit)) {
          return $data;
      }
      $stmt = $this->mysqli->prepare('
      SELECT
  ...
  {
      $this->debug->append('STA '.__METHOD__, 4);
      if ($data = $this->memcache->get(__FUNCTION__.$iHeight.$limit)) {
          return $data;
      }
      $stmt = $this->mysqli->prepare('
      SELECT
  ...
  {
      $this->debug->append('STA '.__METHOD__, 4);
      if ($data = $this->memcache->get(__FUNCTION__.$account_id.$limit)) {
          return $data;
      }
      $stmt = $this->mysqli->prepare('
      SELECT
  ...
  public function updateShareStatistics($aStats, $iBlockId)
  {
      ...
      if ($this->checkStmt($stmt) && $stmt->bind_param('iiii', $aStats['id'], $aStats['valid'], $aStats['invalid'], $iBlockId) && $stmt->execute()) {
          return true;
      }
  ...
  public function insertPPLNSStatistics($aStats, $iBlockId)
  {
      ...
      if ($this->checkStmt($stmt) && $stmt->bind_param('iiiiii', $aStats['id'], $aStats['valid'], $aStats['invalid'], $aStats['pplns_valid'], $aStats['pplns_invalid'], $iBlockId) && $stmt->execute()) {
          return true;
      }
  ...
  {
      $this->debug->append('STA '.__METHOD__, 4);
      if ($this->getGetCache() && $data = $this->memcache->getStatic(__FUNCTION__)) {
          return $data;
      }
      $stmt = $this->mysqli->prepare('
      SELECT
  ...
  {
      $this->debug->append('STA '.__METHOD__, 4);
      if ($data = $this->memcache->getStatic(__FUNCTION__)) {
          return $data;
      }
      $stmt = $this->mysqli->prepare('
      SELECT
  ...
  public function getUserShares($username, $account_id = null)
  {
    ...
    if ($data = $this->memcache->get(STATISTICS_ALL_USER_SHARES)) {
      ...
      if ($data = $this->memcache->get(__FUNCTION__.$account_id)) {
          return $data;
      }
      $stmt = $this->mysqli->prepare("
      SELECT
  ...
  {
      $this->debug->append('STA '.__METHOD__, 4);
      if ($this->getGetCache() && $data = $this->memcache->get(__FUNCTION__.$account_id)) {
          return $data;
      }
      $stmt = $this->mysqli->prepare('
      SELECT
  ...
  public function getTopContributors($type = 'shares', $limit = 15)
  {
      ...
      switch ($type) {
    case 'shares':
      if ($this->getGetCache() && $data = $this->memcache->get(__FUNCTION__.$type.$limit)) {
          return $data;
      }
      if ($data = $this->memcache->get(STATISTICS_ALL_USER_SHARES)) {
    ...
    case 'hashes':
      if ($this->getGetCache() && $data = $this->memcache->getStatic(__FUNCTION__.$type.$limit)) {
          return $data;
      }
      $stmt = $this->mysqli->prepare('
         SELECT
  ...
  {
      $this->debug->append('STA '.__METHOD__, 4);
      if ($data = $this->memcache->get(__FUNCTION__.$hour)) {
          return $data;
      }
      $stmt = $this->mysqli->prepare('
      SELECT
