    ...
    if (isset($_POST['do']) && $_POST['do'] == 'genPin') {
        ...
        if (@$_POST['do'] && !$user->checkPin($_SESSION['USERDATA']['id'], @$_POST['authPin'])) {
          ...
          case 'updateAccount':
            ...
            } elseif (!$config['csrf']['enabled'] || $config['csrf']['enabled'] && $csrftoken->valid) {
