<article class="module width_full">
  <header><h3>Transaktionen</h3></header>
...
<article class="module width_quarter">
  <header><h3>Transaktionen Filter</h3></header>
...
<article class="module width_3_quarter">
  <header><h3>Transaktionen Historie</h3></header>
...
{section transaction $TRANSACTIONS}
        <tr class="{cycle values="odd,even"}">
          ...
          <td align="center">
            ...
            }<span class="confirmed">Best&auml;tigt</span>
            {else if $TRANSACTIONS[transaction].confirmations == -1}<span class="orphan">Verwaist</span>
            {else}<span class="unconfirmed">Unbest&auml;tigt</span>{/if}
          </td>
...
{/section}
    ...
    <footer><p style="margin-left: 25px; font-size: 9px;"><b>Debit_AP</b> = Automatische Auszahlung, <b>Debit_MP</b> = Manuelle Auszahlung, <b>Donation</b> = Spende, <b>Fee</b> = Pool Steuern (falls anwendbar)</p></footer>
</article>
