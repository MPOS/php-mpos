...
{if $NEWS[news].active == 0}<font size="2px"><span class="red"><b>inactive</b></font><br /><br />{/if}</header>
  ...
  <footer>
    <div class="submit_link">
      ...
      <a href='{$smarty.server.PHP_SELF}?page={$smarty.request.page|escape}&action={$smarty.request.action|escape}&do=delete&id={$NEWS[news].id}'><i class="fa fa-ban"></i></a>
    </div>
  </footer>
</article>
{/section}
