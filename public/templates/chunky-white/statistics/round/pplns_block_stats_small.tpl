  ...
  <table class="tablesorter">
	...
	{/if}
      ...
      <tr class="odd">
        ...
        <td>{math assign="percentage2" equation=(($BLOCKDETAILS.estshares / $BLOCKAVERAGE) * 100)}<span class="{if ($percentage2 >= 100)}green{else}red{/if}">{$percentage2|number_format:"2"} %</span></td>
      </tr>
      <tr class="odd">
        <td>Difficulty</td>
        ...
        <td>{math assign="percentage" equation=(($BLOCKDETAILS.estshares / $PPLNSSHARES) * 100)}<span class="{if ($percentage >= 100)}green{else}red{/if}">{$percentage|number_format:"2"} %</span></td>
      </tr>
      <tr class="odd">
        <td>Shares</td>
        ...
        <td>{math assign="percentage1" equation=(($BLOCKDETAILS.shares / $PPLNSSHARES) * 100)}<span class="{if ($percentage1 >= 100)}green{else}red{/if}">{$percentage1|number_format:"2"} %</span></td>
      </tr>
    </tbody>
  </table>
  <footer>
