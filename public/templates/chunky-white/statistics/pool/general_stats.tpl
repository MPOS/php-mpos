 <article class="widget col-md-5" style="margin-right: 25px;">
  ...
  <div class="module_content">
    <table width="100%" class="table table-hover">
      ...
      {if ! $GLOBAL.website.chaininfo.disabled}
          <td><a href="{$GLOBAL.website.chaininfo.url}" target="_new"><font size="2"><span id="b-diff">{$NETWORK.EstNextDifficulty} (Change in {$NETWORK.BlocksUntilDiffChange} Blocks)</span></font></a></td>
      {else}
          <td><font size="2"><span id="b-diff">{$NETWORK.EstNextDifficulty} (Change in {$NETWORK.BlocksUntilDiffChange} Blocks)</span></font></td>
      {/if}
        </tr>
        <tr>
