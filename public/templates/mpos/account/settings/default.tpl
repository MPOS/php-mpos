<article class="module width_full">
  <form method="POST">
    ...
    <header>
      <h3 class="tabs_involved">Account Settings</h3>
      <ul style="margin: 40px 20px 0px 0px;" class="tabs">
{foreach item=TAB from=array_keys($SETTINGS)}
		{if $TAB == 'GoogleAuth' && $GLOBAL.twofactor.mode == "gauth" && $GLOBAL.twofactor.enabled}
		  <li><a href="?page=account&action=gauth">{$TAB|capitalize}</a></li>
		{elseif $TAB !== 'GoogleAuth'}
