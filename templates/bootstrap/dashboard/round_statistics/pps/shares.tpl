      <table class="table borderless m-b-none text-small">
        <thead>
          <tr>
            <th></th>
            <th><span><h5><i class="fa fa-user fa-fw"></i> {t}Own{/t}<h5></th>
            <th><span><h5><i class="fa fa-users fa-fw"></i> {t}Pool{/t}</h6></span></th>
          </tr>
          <tr>
            <th><h5><i class="fa fa-smile-o fa-fw"></i> {t}Valid{/t}</h6></th>
            <th>
          ...
          <tr>
            <th><h5><i class="fa fa-frown-o fa-fw"></i> {t}Invalid{/t}</h6></th>
            <th>
            <div class="progress progress-striped progress-fix">
