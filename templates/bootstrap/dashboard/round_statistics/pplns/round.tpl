          ...
          <div class="col-lg-2 col-sm-6">
            <div class="circle-tile fade">
              ...
              <div class="circle-tile-content lightblue">
                ...
                <div class="circle-tile-number text-faded">
                  <p class="h6">Est. Next Difficulty{if $NETWORK.BlocksUntilDiffChange > 1}{if $GLOBAL.nethashrate > 0}<br/>Change in {$NETWORK.BlocksUntilDiffChange} Blocks{else}No Estimates{/if}{/if}</p>
                </div>
              </div>
            </div> 
         </div>
