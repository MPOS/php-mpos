/* don't forget currency at bottom */

CREATE DATABASE IF NOT EXISTS litecoin;
USE litecoin;
...
) ENGINE=FEDERATED  DEFAULT CHARSET=utf8 CONNECTION='mysql://user:pass@localhost/chunky/accounts';
...
CREATE TABLE IF NOT EXISTS `coin_addresses` (
  ...
  `ap_threshold` float DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=FEDERATED DEFAULT CHARSET=utf8 CONNECTION='mysql://user:pass@localhost/chunky/coin_addresses';
...
) ENGINE=FEDERATED  DEFAULT CHARSET=utf8 CONNECTION='mysql://user:pass@localhost/chunky/pool_worker';
...
INSERT INTO `settings` (name, value) values('currency', 'LTC');
